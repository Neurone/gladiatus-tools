...
it.neurone.gladiatustools.xmlhttpRequester = function (unsafeContentWin, chromeWindow) {
...
it.neurone.gladiatustools.xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				it.neurone.gladiatustools.gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
it.neurone.gladiatustools.xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
it.neurone.gladiatustools.xmlhttpRequester.prototype.setupRequestEvent = function(unsafeContentWin, req, event, details) {
	if (details[event]) {
		req[event] = function() {
			var responseState = {
